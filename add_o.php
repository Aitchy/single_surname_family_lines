<!-- Add details for a Other Mutch entry in Others table.-->
<!-- WORKING -->
...
//  <!-- main content section -->
  ...
  echo ("<b>Enter details for Other Mutch</b><br />");
  ...
  echo ("<input type=\"text\" name=\"sur_name\" size=\"20\" maxlength=\"30\"> ");
  echo ("<br />");
  ...
  echo ("<br />");
  echo ("<b>Note:</b><br />");
  echo ("<textarea name=\"o_note\" cols=60 rows=5 wrap=virtual></textarea>");
...
// *****IF SUBMIT PUSHED*****
 ...
 // CREATE record
  $stmt = $conn->prepare("INSERT INTO Others (first_name,
    second_name,
    third_name,
    surname,
    sex,
...
// UPDATE record
  $stmt->bind_param('sssssiiiissiiissiiisssss',
    $_POST['f_name'],
    $_POST['s_name'],
    $_POST['t_name'],
    $_POST['sur_name'],
...
// Get the new records id
  ...
  $sel = "select * from Others where id = ".$new_id."";
  ...
  echo ("<br />");
  echo ("<br />");
  echo ("<a href=\"edit_o.php?id=".$new_id."&mutch=".$_POST[mutch]."\">Modify entry</a>");
  echo ("</div>");
//  <!-- main content section -->
  echo ("<div id=\"centercontentmain\">");
  echo ("<br />");
  echo ("<p><b>ADDED ID = ".$new_id." TO OTHERS DATABASE</b></p>");
// refresh form
  //<form action=" ">
  //########
  echo ("<b>Details entrered for ID=".$row_o["id"]."</b><br />");
  echo ("First name = ".$row_o["first_name"]."<br />");
  echo ("Second name = ".$row_o["second_name"]."<br />");
  echo ("Third name = ".$row_o["third_name"]."<br />");
  echo ("Surname = ".$row_o["surname"]."<br />");
  echo ("<br />");
  echo ("Sex = ");
  if ($row_o["sex"]=="m") {
    echo ("male ");
